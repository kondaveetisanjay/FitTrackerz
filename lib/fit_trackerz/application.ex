defmodule FitTrackerz.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: FitTrackerz.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    FitTrackerzWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
