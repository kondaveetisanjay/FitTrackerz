      ...
      <div class="space-y-8">
        ...
        <% else %>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="ft-card p-6" id="stat-total-attendance">
            ...
            <div class="ft-card p-6" id="stat-gyms-count">
              <div class="flex items-center justify-between">
                <div>
                  <p class="text-xs font-semibold text-base-content/40 uppercase tracking-wider">
                    Active Gyms
            ...
            <div class="ft-card p-6" id="stat-this-month">
              <div class="flex items-center justify-between">
                <div>
                  <p class="text-xs font-semibold text-base-content/40 uppercase tracking-wider">
                    This Month
          ...
          <%= if @attendance_records == [] do %>
            <%!-- Empty State --%>
            <div class="ft-card p-6" id="no-attendance">
              <div class="card-body items-center text-center p-8">
          ...
          <% else %>
            <%!-- Attendance Table --%>
            <div class="ft-card p-6" id="attendance-table">
