defmodule FitTrackerzWeb.Member.DashboardLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_user={@current_user}>
      <div class="space-y-6">
        <%!-- Welcome Header --%>
        <div class="rounded-2xl bg-gradient-to-br from-primary/5 via-base-100 to-secondary/5 ft-card p-6 sm:p-8">
        ...
        <%= if @pending_invitations != [] do %>
          <div class="ft-card p-6" id="pending-invitations">
            ...
            <div class="space-y-3 mt-4">
              <%= for inv <- @pending_invitations do %>
                <div
                  class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 bg-base-200/30 rounded-xl hover:border-primary/20 transition-colors"
        ...
        <% else %>
          ...
          <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="animate-fade-up" style="animation-delay: 75ms;">
              <.stat_card
                label="Attendance"
            ...
            <div class="animate-fade-up" style="animation-delay: 225ms;">
              <.stat_card
                label="Calories"
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <%!-- My Workout Plan --%>
            <div class="ft-card p-6" id="my-workout">
            ...
            <%!-- My Diet Plan --%>
            <div class="ft-card p-6" id="my-diet">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <%!-- Upcoming Bookings --%>
            <div class="lg:col-span-2 ft-card p-6" id="upcoming-bookings">
                ...
                <% else %>
                  <div class="space-y-2">
                    <%= for booking <- @upcoming_bookings do %>
                      <div class="flex items-center gap-3 p-3 rounded-xl bg-base-200/30 hover:bg-base-200/50 transition-colors">
            ...
            <%!-- Subscription Status --%>
            <div class="ft-card p-6" id="subscription-status">
