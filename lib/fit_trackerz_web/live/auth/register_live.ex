    ...
    <div class="min-h-screen flex">
      ...
      <div class="flex-1 flex items-center justify-center p-6 sm:p-12 bg-base-100">
        <div class="w-full max-w-md">
          ...
          <form action="/auth/user/password/register" method="post" class="space-y-4 mt-4">
          ...
          <.button navigate="/sign-in" variant="outline" class="btn btn-outline btn-primary w-full gap-2 font-semibold rounded-xl">
