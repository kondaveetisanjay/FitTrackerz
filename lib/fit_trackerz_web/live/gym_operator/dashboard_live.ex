      ...
      <div class="space-y-8">
        <%= if @has_gym do %>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <.stat_card
              ...
              value={@pending_member_invites}
              icon="hero-envelope-solid"
              color="warning"
              subtitle="Awaiting response"
              href="/gym/invitations"
              id="stat-invites"
            />
          </div>
          <%!-- Tab Navigation --%>
          ...
          <div class="ft-card p-6">
            <%= case @active_tab do %>
              <% "details" -> %>
                ...
                <div class="space-y-3">
                  <div class="flex items-center gap-3 bg-base-200/30 rounded-xl p-4">
                ...
                <%= if @gym.branches != [] do %>
                  <div class="space-y-3">
                    <%= for branch <- @gym.branches do %>
                      <div class="flex items-start gap-4 bg-base-200/30 rounded-xl p-4">
        ...
        <% else %>
          ...
          <div class="min-h-[60vh] flex items-center justify-center">
            <div class="ft-card text-center max-w-md">
