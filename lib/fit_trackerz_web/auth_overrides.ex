defmodule FitTrackerzWeb.AuthOverrides do
  ...
  override Components.Banner do
    ...
    set(:text, "FitTrackerz")
  end

  override Components.Password do
    set(:register_extra_component, &FitTrackerzWeb.AuthComponents.register_extra/1)
  end
...
defmodule FitTrackerzWeb.AuthComponents do
